...
import { Collapsible, CollapsibleContent } from '@/src/app/shared/components'
...
type VerticalStepProps = StepSharedProps & { children?: React.ReactNode }

const verticalStepVariants = cva(
  [
    'flex flex-col relative transition-all duration-200',
    'data-[completed=true]:[&:not(:last-child)]:after:bg-primary',
    'data-[completed=false]:[&:not(:last-child)]:after:bg-gray-200',
        ...
        return (
          <Collapsible open={isCurrentStep}>
            <CollapsibleContent
              ...
              className='data-[state=open]:animate-collapsible-down data-[state=closed]:animate-collapsible-up overflow-hidden px-2'
            >
              {children}
            </CollapsibleContent>
          </Collapsible>
